...
## GUI tools of ROS2 on WSL2
- Download [VcXsrv](https://sourceforge.net/projects/vcxsrv/) and install using the default settings
- Lauch VcXsrc and in the extra settings,  uncheck **Native opengl** and to check **Disable access control**
- Type the following in the terminal and that's it!
    ```
    export DISPLAY=$(cat /etc/resolv.conf | grep nameserver | awk '{print $2}'):0 
    ```
-![image](https://github.com/guyuxuan9/UROP_robotic_arm/assets/58468284/79a3a476-d4bb-4d7d-94b7-cdeeebefc00b)

- [Reference 1](https://turlucode.com/running-ros-inside-windows-10-with-gui-support-wsl/), [Reference 2](https://www.youtube.com/watch?v=DW7l9LHdK5c)
